...
export function ExhibitionForm({ expoId, defaultValues }: { expoId?: string; defaultValues?: Partial<FormData> }) {
    ...
    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { name: 'priceBase', label: 'Inscription de base' },
            ...
            <div key={name}>
              ...
              <input {...register(name as keyof FormData, { valueAsNumber: true })} type="number" step="0.01" min="0" className="form-input" />
            </div>
          ))}
        </div>
        <div className="w-48">
